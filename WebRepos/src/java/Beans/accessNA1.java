...
@ManagedBean
@RequestScoped
public class accessNA1 {
    public accessN220 AN22 =  new accessN220();
    ...
    /**
     * Creates a new instance of accessNA1
     */
    public accessNA1() {
    }
    ...
    public String VerificarSubA() {
        System.out.println("MetodNA1-> CodSu1: "+AN22.CodSuSu1);
        if(AN22.CodSuSu1.equals("12")){//Verifica si es la carpeta Seleccionada
            compCod = AN22.CodSuSu1;
            compNom = AN22.NomSuSu1;
            System.out.println("AccessSubCarpeta3--"+compNom +"%%" + compCod);
        }else{
            compNom ="Error";
        }
        return compNom;
        ...
        if (cn == null) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    Sub = datos[3];
                    if(Sub.equals("12")){ //Verificar q venga subc=12
                        if(contador==0){
                            A1 = datos[1];
                            CodSuSu1 = datos[0];
                            NomSuSu1 = A1;
                    ...
                    System.out.println("ANA1: " + datos[0]+ " "+ datos[1]);
                    contador++;
                }
