...
@ManagedBean
@RequestScoped
public class accessNA6 {
    public accessN60 AN6 =  new accessN60();
    ...
    /**
     * Creates a new instance of accessNA6
     */
    public accessNA6() {
    }
    ...
    public String VerificarSubA() {
        if(AN6.CodSu1.equals("5")){//Verifica si es la carpeta Seleccionada
            compCod = AN6.CodSu1;
            compNom = AN6.NomSu1;
            System.out.println("AccessSubVentana5--"+compNom +"%%" + compCod);
        }else{
            compNom ="Error";
        }
        return compNom;
        ...
        if (cn == null) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    Sub = datos[3];
                    if(Sub.equals("15")){ //Verificar q venga subc=12
                        if(contador==9){
                            A1 = datos[1];
                            CodSuSu1 = datos[0];
                            NomSuSu1 = A1;
                    ...
                    System.out.println("ANA6: " + datos[0]+ " "+ datos[1]);
                    contador++;
                }
