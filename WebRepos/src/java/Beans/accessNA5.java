...
@ManagedBean
@RequestScoped
public class accessNA5 {
    public access5 AS5 =  new access5();
    ...
    /**
     * Creates a new instance of accessNA5
     */
    public accessNA5() {
    }
    ...
    public String VerificarSubA() {
        if(AS5.CodC.equals("5")){//Verifica si es la carpeta Seleccionada
            compCod = AS5.CodC;
            compNom = AS5.NomC;
        ...
        if (cn == null) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    Sub = datos[3];
                    if(Sub.equals("13")){ //Verificar q venga subc=12
                        if(contador==8){
                            A1 = datos[1];
                            CodSuSu1 = datos[0];
                            NomSuSu1 = A1;
                    ...
                    System.out.println("ANA5: " + datos[0]+ " "+ datos[1]);
                    contador++;
                }
