...
@ManagedBean
@RequestScoped
public class accessNA2 {
    public access2 AS2 =  new access2();
    ...
    /**
     * Creates a new instance of accessNA2
     */
    public accessNA2() {
    }
    ...
    public String VerificarSubA() {
        if(AS2.CodC.equals("5")){//Verifica si es la carpeta Seleccionada
            compCod = AS2.CodC;
            compNom = AS2.NomC;
            System.out.println("AccessSubC--"+compNom +"%%" + compCod);
        }else{
            compNom ="Error";
        }
        return compNom;
        ...
        if (cn == null) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    Sub = datos[3];
                    if(Sub.equals("5")){ //Verificar q venga subc=12
                        if(contador==3){
                            A1 = datos[1];
                            CodSuSu1 = datos[0];
                            NomSuSu1 = A1;
