...
@ManagedBean
@RequestScoped
public class accessNA31 {
    public access3 AN3 =  new access3();
    ...
    /**
     * Creates a new instance of accessNA31
     */
    public accessNA31() {
    }
    ...
    public String VerificarSubA() {
        System.out.println("MetodNA31-> CodSu2: "+AN3.CodMa);
        if(AN3.CodMa.equals("9")){//Verifica si es la carpeta Seleccionada
            compCod = AN3.CodMa;
            compNom = AN3.NomMa;
            System.out.println("AccessSubCManua--"+compNom +"%%" + compCod);
        }else{
            compNom ="Error";
        }
        return compNom;
        ...
        if (cn == null) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    Sub = datos[3];
                    if(Sub.equals("9")){ //Verificar q venga subc=7
                        if(contador==1){
                            A1 = datos[1];
                            CodSuSu1 = datos[0];
                            NomSuSu1 = A1;
                    ...
                    System.out.println("ANA31: " + datos[0]+ " "+ datos[1]);
                    contador++;
                }
