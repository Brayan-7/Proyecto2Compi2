...
public class access4 {
    ...
    public String VerificarSubC(){
        if(A1.SubCod3.equals("3")){//Ver PROYECTO PERTENECIENTE
            CodS2 = A1.SubCod3;
            NomS2 = A1.SubNom3;
            System.out.println("Access4--"+NomS2 +"%%" + CodS2);
        }else{
            NomS2 ="Error";
        }
        return NomS2;
    ...
    public String ShowRepos(){
        ...
        if (cn == null) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if(Proj.equals("3") && Sub.equals("1")){
                        if(contador==4){
                            Repos1 = datos[1];
                            CodS1 = datos[0];
                            NomS1 = Repos1; System.out.println(">>>4 "+CodS1);
                        }else if(contador==5){
                            Repos2 = datos[1];
                            CodS2 = datos[0];
                            NomS2 = Repos2;
                    ...
                    System.out.println("A4: " + datos[0]+ " "+ datos[1]);
                    contador++;
                }
        ...
        return "ventana4.xhtml";
    }

    /**
     * Creates a new instance of access4
     */
    public access4() {
    }
