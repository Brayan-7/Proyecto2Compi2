...
public class access3 {
    ...
    public String CodS13, NomS13; public String CodS14, NomS14; public String CodS15, NomS15;
    public String CodS16, NomS16; public String CodS17, NomS17;public String CodS18, NomS18; public String CodS19, NomS19;
    public String CodS20, NomS20;
    
    public static String CodMa, NomMa;
    
    //VARIABLES PARA GUARDAR LOS DATOS DE LA BD
    public String Repos1;    public String Repos2;
    public String Repos3;    public String Repos4;
    public String Repos5;    public String Repos6;
    public String Repos7;    public String Repos8;
    public String Repos9;    public String Repos10;
    public String Repos11;    public String Repos12;
    public String Repos13;    public String Repos14;
    public String Repos15;    public String Repos16;
    public String Repos17;    public String Repos18;
    public String Repos19;    public String Repos20;
    ///**************
    ...
    public String VerificarSubC(){
        //System.out.println("VC->" + A1.SubCod2);
        if(A1.SubCod2.equals("2")){//Proyecto
            CodS2 = A1.SubCod2;
            NomS2 = A1.SubNom2;
            System.out.println("Access3--"+NomS2 +"%%" + CodS2);
        }else{
            NomS2 ="Error";
        }
        return NomS2;
    ...
    public String ShowRepos(){
        ...
        if (cn == null) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if(Proj.equals("2") && Sub.equals("1")){
                        if(contador==3){
                            Repos1 = datos[1];
                            CodS1 = datos[0];
                            NomS1 = Repos1;
                            System.out.println(">>>1 " + CodS1);
                        }else if(contador==6){
                            Repos2 = datos[1];
                            CodS2 = datos[0];
                            NomS2 = Repos2;
                            CodMa=CodS2; NomMa=NomS2;
                            System.out.println(">>>2 " + CodS2);
                        }else if(contador==7){
                            Repos3 = datos[1];
                            CodS3 = datos[0];
                            NomS3 = Repos3;
                            System.out.println(">>>3 " + CodS3);
                        }else if(contador==8){
                            Repos4 = datos[1];
                            CodS4 = datos[0];
                            NomS4 = Repos4;
                            System.out.println(">>>4 " + CodS4);
                        }else if(contador==9){
                            Repos5 = datos[1];
                            CodS5 = datos[0];
                            NomS5 = Repos5;
                            System.out.println(">>>5 " + CodS5);
                        }else if(contador==10){
                            Repos6 = datos[1];
                            CodS6 = datos[0];
                            NomS6 = Repos6;
        ...
        return "ventana3.xhtml";
    }
    /**
     * Creates a new instance of access3
     */
    public access3() {
    }
