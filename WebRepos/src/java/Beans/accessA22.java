...
@ManagedBean
@RequestScoped
public class accessA22 {
    public ConexionBD con; //INSTANCIANDO LA CONEXION CON LA BD
    public accessNA31 A3 = new accessNA31();

    /**
     * Creates a new instance of accessA22
     */
    public accessA22() {
    }
        ...
        if (cn == null) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    NomAr = datos[1];
                    if(datos[3].equals("9") && A3.NomSuSu1.equals(NomAr)){ //SubCarpeta=9 y NombreArchivo=NomAr
                        msj = NomAr;
                    }
                }
        ...
        if (cn == null) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    datos[2] = rs.getString(3); datos[3] = rs.getString(4);
                    NomAr = datos[1];
                    if(datos[3].equals("9") && A3.NomSuSu1.equals(NomAr)){
                        msj = datos[2];
                    }
                }
                System.out.println("¬¬¬¬¬¬¬¬CONECTADO¬¬¬¬¬¬¬");
