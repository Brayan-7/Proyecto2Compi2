...
public class access2 {
    ...
    public static String CodS16, NomS16, CodS17, NomS17, CodS18, NomS18, CodS19, NomS19, CodS20, NomS20;
    ...
    public String VerificarSubC(){
        if(A1.SubCod1.equals("1")){//Verifica si el proyecto 1
            CodS2 = A1.SubCod1;
            NomS2 = A1.SubNom1;
            System.out.println("Access2--"+NomS2 +"%%" + CodS2);
        }else{
            NomS2 ="Error";
        }
        return NomS2;
    ...
    public String ShowRepos(){
        ...
        if (cn == null) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if(Proj.equals("1") && Sub.equals("1")){
                        if(contador==1){
                            Repos1 = datos[1];
                            CodS1 = datos[0];
                            NomS1 = Repos1;
                            System.out.println("<<< "+CodS1);
                        }else if(contador==2){
                            Repos2 = datos[1];
                            CodS2 = datos[0];
                            NomS2 = Repos2;
                            CodC = CodS2;
                            NomC = NomS2;
                            System.out.println("<<< "+CodS2 +">> "+NomS2 );
                        }else if(contador==3){
                            Repos3 = datos[1];
                            CodS3 = datos[0];
                            NomS3 = Repos3;
                    ...
                    System.out.println("A2: " + datos[0]+ " "+ datos[1]);
                    contador++;
                }
        ...
        return "ventana2.xhtml";
    }
    /**
     * Creates a new instance of access2
     */
    public access2() {
    }
