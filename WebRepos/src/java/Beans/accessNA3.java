...
public class accessNA3 {
    ...
    /**
     * Creates a new instance of accessNA3
     */
    public accessNA3() {
    }
    ...
    public String VerificarSubA() {
        System.out.println("MetodNA3-> CodS1: "+AN3.CodS1);
        if(AN3.CodS1.equals("6")){//Verifica si es la carpeta Seleccionada
            compCod = AN3.CodS1;
            compNom = AN3.NomS1;
        ...
        if (cn == null) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    Sub = datos[3];
                    if(Sub.equals("6")){ //Verificar q venga subc=12
                        if(contador==1){
                            A1 = datos[1];
                            CodSuSu1 = datos[0];
                            NomSuSu1 = A1;
                    ...
                    System.out.println("ANA2: " + datos[0]+ " "+ datos[1]);
                    contador++;
                }
