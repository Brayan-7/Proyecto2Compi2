...
public class access6 {
    ...
    public String CodS1, NomS1, CodS2, NomS2, CodS3, NomS3;
    public String CodS4, NomS4, CodS5, NomS5, CodS6, NomS6;
    public String CodS7, NomS7, CodS8, NomS8, CodS9, NomS9;
    public String CodS10, NomS10, CodS11, NomS11, CodS12, NomS12;
    public String CodS13, NomS13, CodS14, NomS14, CodS15, NomS15;
    public String CodS16, NomS16, CodS17, NomS17, CodS18, NomS18, CodS19, NomS19;
    ...
    public String VerificarSubC(){
        if(A1.SubCod5.equals("6")){//Ver PROYECTO PERTENECIENTE
            CodS2 = A1.SubCod5;
            NomS2 = A1.SubNom5;
            System.out.println("Access6--"+NomS2 +"%%" + CodS2);
        }else{
            NomS2 ="Error";
        }
        return NomS2;
        ...
        if (cn == null) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    System.out.println("A6: " + datos[0]+ " "+ datos[1]);
                    contador++;
                }
    ...
    /**
     * Creates a new instance of access6
     */
    public access6() {
    }
